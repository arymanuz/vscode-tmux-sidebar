...
import { ProgramSpec, allBins, getProgramSpecs, probeBins, resetAvailability, sanitizeSpecs } from './programs';
...
export function openSettingsPanel(extensionUri: vscode.Uri): void {
    ...
    panel.webview.onDidReceiveMessage(async (msg: any) => {
        if (msg.type === 'save') {
            ...
            const availability = await probeBins(Array.isArray(msg.bins) ? msg.bins : []);
